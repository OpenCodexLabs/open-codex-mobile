...
class ThreadHistoryDecoderSanitizationTest {
    ...
    @Test
    fun decodeFromThreadRead_decodesJsonlFallbackMessageItems() {
        val history =
            ThreadHistoryDecoder.decodeFromThreadRead(
                threadId = "thread-jsonl",
                threadObject =
                    mapOf(
                        "remodexJsonlFallback" to JSONValue.Bool(true),
                        "turns" to
                            JSONValue.Arr(
                                listOf(
                                    JSONValue.Obj(
                                        mapOf(
                                            "id" to JSONValue.Str("turn-jsonl"),
                                            ...
                                            "items" to
                                                JSONValue.Arr(
                                                    listOf(
                                                        JSONValue.Obj(
                                                            mapOf(
                                                                "id" to JSONValue.Str("user-jsonl"),
                                                                "type" to JSONValue.Str("user_message"),
                                                                "role" to JSONValue.Str("user"),
                                                                "message" to JSONValue.Str("open this thread"),
                                                            ),
                                                        ),
                                                        JSONValue.Obj(
                                                            mapOf(
                                                                "id" to JSONValue.Str("assistant-jsonl"),
                                                                        ...
                                                                        listOf(
                                                                            JSONValue.Obj(
                                                                                mapOf(
                                                                                    ...
                                                                                    "text" to JSONValue.Str("loaded from local jsonl"),
                                                                                ),
                                                                            ),
                                                                        ),
                                                                    ),
        ...
        assertEquals(CodexMessageRole.user, history[0].role)
        assertEquals("open this thread", history[0].text)
        assertEquals(CodexMessageRole.assistant, history[1].role)
        assertEquals("loaded from local jsonl", history[1].text)
    }
