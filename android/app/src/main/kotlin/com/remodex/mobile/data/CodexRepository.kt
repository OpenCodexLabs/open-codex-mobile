...
interface CodexRepository {
    ...
    suspend fun setThreadPinned(
        threadId: String,
        pinned: Boolean,
    ): Unit = throw UnsupportedOperationException("setThreadPinned is not implemented by this repository")

    suspend fun setPinnedThreadOrder(threadIds: List<String>): Unit =
        throw UnsupportedOperationException("setPinnedThreadOrder is not implemented by this repository")
